...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('static', 'static'), ('routers', 'routers'), ('services', 'services'), ('models', 'models'), ('utils', 'utils')],
    ...
    hooksconfig={},
    runtime_hooks=[],
    excludes=['tkinter', '_tkinter', 'matplotlib', 'IPython', 'ipykernel', 'jupyter', 'nbformat', 'nbconvert', 'notebook'],
    noarchive=False,
    optimize=0,
)
pyz = PYZ(a.pure)
